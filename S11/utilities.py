...
class AlbumentateTrainData(Dataset):
    def __init__(self, image_list, labels, mean=(0, 0, 0), std=(1,1,1)):
        ...
        self.transforms = A.Compose([
            A.PadIfNeeded (min_height=40, min_width=40, border_mode=0, value=[0, 0, 0], always_apply=True),
            # border_mode = 0 corresponds to cv2.BORDER_CONSTANT
            A.RandomCrop(32, 32, p=1),
            A.HorizontalFlip(p=0.5),
            A.Cutout(num_holes=4, max_h_size=8, max_w_size=8, fill_value=self.mean, p=0.5),
...
def plot_loss(train_loss_vals,test_loss_vals,epochs):
    ...
    plt.show()
    my_dpi = 100
    loss.savefig('S11/images/S11_loss.png',figsize=(800/my_dpi, 800/my_dpi), dpi=my_dpi)
...
def plot_acc(train_acc_vals,test_acc_vals,epochs):
    ...
    plt.show()
    my_dpi = 100
    acc.savefig('S11/images/S11_accuracy.png',figsize=(800/my_dpi, 800/my_dpi), dpi=my_dpi)
...
def plot_misclassified(Net,MODEL_PATH,test_loader,
    ...
    plt.show()
    my_dpi = 100
    fig1.savefig('S11/images/S11_misclassified_images.png',figsize=(800/my_dpi, 800/my_dpi), dpi=my_dpi)
    fig2.savefig('S11/images/S11_misclassified_gradcam.png',figsize=(800/my_dpi, 800/my_dpi), dpi=my_dpi)
...
def plot_correct_classified(Net,MODEL_PATH,test_loader,
    ...
    plt.show()
    my_dpi = 100
    fig1.savefig('S11/images/S11_correct_classified_images.png',figsize=(800/my_dpi, 800/my_dpi), dpi=my_dpi)
    fig2.savefig('S11/images/S11_correct_classified_gradcam.png',figsize=(800/my_dpi, 800/my_dpi), dpi=my_dpi)
